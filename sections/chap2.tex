...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.7\textwidth}
         \centering
         \includegraphics[width=0.35\textwidth]{figures/chap2/asn_Jprot.pdf}
     ...
     \end{subfigure}
        ...
        Asn is consumed into protein synthesis (Protein) and leakage into the media (Efflux) assuming no Asn is provided to the media.
        }
\end{figure}
...
The explicit assumption is that asparagine can be generated from synthesis using aspartate but not recycled back and this makes the asparagine fluxes suitable for isotope tracing.
...
%    \includegraphics[width=0.35\textwidth]{figures/chap2/asn_Jprot.pdf}
%    \caption[Asparagine consumption fluxes]{
%    Diagram of asparagine fluxes in a cell.
%    Net influx of U-\hCi{} labelled Asn ($\Flin$), net efflux of unlabelled Asn ($\Flout$), net deposition of Asn into protein ($\Flprot$) and Asn synthesis from Asp ($\Flsyn$).
%    Asn symbolized by green and U-\hCi{} Asn symbolized by blue.
%    }
%    \label{fig:ch2:asn_Jprot}
...
%%%%%%%%%%
%%% Check above equations
%%% Reform the Jupyter notebook to same format
%%% Report Jprot and Jsyn separately on the barchart (use * and #)
%%%%%%%%%%%
