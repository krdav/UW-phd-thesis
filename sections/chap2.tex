...
\begin{figure}
    ...
    \caption[Inferred salvage paths into purines]{
    ggg
    }
...
\begin{figure}
     ...
     \end{subfigure}
        ...
        (c) Rotenone can partially prevent ATF4 reporter expression.
        (d) GOT DKO cells are not responding to mitochondrial inhibitors; however, they do respond to aspartate depletion (figure \ref{fig:app_ch2:HT1080_GOT_DKO_Asp_ATF4rep}).
        Similar data for other clones in figure \ref{fig:app_ch2:ISR}.
        For western blot validations see figure \ref{fig:app_ch2:HT1080_ISR_western}.
        }
        \label{fig:ch2:ISR}
\end{figure}
...
Cell treated with drugs x,y,z concentration etc.
Samples processed as described in chapter \ref{chap5}.
