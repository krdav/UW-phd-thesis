...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{figures/chap2/asp_fate.pdf}
    ...
    Results either with or without Asn efflux.
    }
...
Licor, antibodies (primaries) etc.
...
Genes (SLC1A3, gpASNase, eGFP, ASNS, ATF4 reporter) were first cloned into entry vector pENTR1A (Fisher, A10462) using NEBuilder HiFI DNA Assembly Cloning Kit (New England BioLabs, E2621).
...
For pyrimidine nucleobase/nucleoside quantification this pool was also mixed with equimolar uracil (Sigma-Aldrich, U1128), uridine (Sigma-Aldrich, U3003), 2′-deoxyuridine (Sigma-Aldrich, D5412), thymine (Sigma-Aldrich, T0376), cytosine (Sigma-Aldrich, C3506) and cytidine (Cayman Chemical, 29602).
